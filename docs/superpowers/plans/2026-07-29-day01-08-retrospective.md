# Day 01–08 八天深度复盘 Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** 在 `docs/review/2026-07-29-day01-08-eight-day-retrospective.md` 落地 8 天深度复盘 review 文档，结构与 [2026-07-22-day01-05-architecture-review.md](../../review/2026-07-22-day01-05-architecture-review.md)、[2026-07-27-day01-07-seven-day-retrospective.md](../../review/2026-07-27-day01-07-seven-day-retrospective.md) 同节奏，聚焦 day07-08 详细演进 + STAR 法则 4 个亮点故事。

**Architecture:** 单 review markdown 文档，约 1100 行 / 90-110 KB。9 个 section：① 一览 / ② 8 天总览（day01-06 简略 + day07-08 详细）/ ③ Day 07 详细 / ④ Day 08 详细 / ⑤ 当前架构 / ⑥ 核心概念（Day 07-08 增量）/ ⑦ ADR 增量 / ⑧ 面试视角 STAR / ⑨ Day 09+ 路线 + 技术债。复用 day01-07 review / day08.md / ADR-0001 通过 markdown 链接而非重写。

**Tech Stack:** Markdown / 现有 review 文档作为引用源 / 不引入新依赖。

---

## Global Constraints

- **不动 libs/ 代码** —— review 是文档，不引入新内容到 libs 层。
- **不重写 day01-06 day-by-day 演进** —— 引用 day01-07 §1 / §2。
- **不重写 ADR-001~012** —— 引用 day01-07 §4，仅新加 ADR-013~015。
- **不预测 Day 09+ 未来** —— §9 仅列 day08.md "Day 09 预告"已 ack 的 5 个决策。
- **commit 节奏** —— 每个 task 完成后独立 git commit。
- **pre-commit 走 lint-staged** —— Husky + commitlint 已就绪。
- **不引入新代码风格** —— 沿用 day01-07 review 风格（emoji section 标题 / 表格 / 链接相对路径）。
- **markdown 链接必须用相对路径** —— `[xxx](../path/xxx.md)` 形式。
- **目标字数预算** —— 总行数 1000-1200 行（不超过 day01-07 的 1500 行太多）。
- **STAR 故事 S/T/A/R 必须实** —— 每个引用具体 commit / 代码行 / 数字。
...
**Files to create:**
- `docs/review/2026-07-29-day01-08-eight-day-retrospective.md`（新建 review 文档，约 1100 行）

**Files to reference (read-only):**
- `docs/review/2026-07-22-day01-05-architecture-review.md`（5 天节奏点）
- `docs/review/2026-07-27-day01-07-seven-day-retrospective.md`（7 天 full retrospective，主要复用源）
- `docs/daily/day01.md` ~ `docs/daily/day08.md`（每日笔记）
- `docs/superpowers/specs/2026-07-29-day01-08-retrospective-design.md`（本次 spec）
- `docs/adr/0001-tool-capability-must-not-embed-in-system-prompt.md`（ADR-0001）

**Files NOT to modify:**
- 任何 `libs/` 或 `apps/` 下源码
- 任何已有 review / daily / spec / plan 文档
- `CLAUDE.md`
...
**Files:**
- Create: `docs/review/2026-07-29-day01-08-eight-day-retrospective.md`（新建空文件 + 写 §1 + 头）

**Interfaces:**
- Produces: 文件首部 + §1 一览（8 行表格）

**Content:**

- [ ] **Step 1: 创建文件骨架（含头 + §1 一览）**
...
跑 `git log --oneline | wc -l` → 预期输出 107。
跑 `cat libs/agent/event.ts` → 数 `kind: '...'` 出现次数 → 预期 12 次（message_start / iteration / request / response / message_delta / context / tool_call / tool_result / message_end / run_summary / done / error）。

- [ ] **Step 3: 跑 prettier check**

跑 `pnpm exec prettier --check docs/review/2026-07-29-day01-08-eight-day-retrospective.md`
预期输出：`Checking formatting... All matched files use Prettier code style!`

- [ ] **Step 4: Commit**

```bash
cd d:/spaceObelish/spaceCode/playgroud/agent/agent-engineer-bootcamp
git add docs/review/2026-07-29-day01-08-eight-day-retrospective.md
git commit -m "docs(review): day01-08 retrospective scaffold + section 1 overview"
```

---

## Task 2: §2 8 天路线总览（day01-06 简略 + day07-08 简介）

**Files:**
- Modify: `docs/review/2026-07-29-day01-08-eight-day-retrospective.md`（追加 §2）

**Interfaces:**
- Consumes: day01-07 §1 七天路线总览（已读 source-of-truth）
- Produces: §2 8 天总览（约 150 行）

**Content:**

- [ ] **Step 1: 写 §2 头部 + Day 01-04 简略段**
...
- [ ] **Step 3: 写 Day 07-08 简介（指向详细 §3 §4）**
...
- [ ] **Step 4: 跑 prettier + 验证字数**

跑 `pnpm exec prettier --check docs/review/2026-07-29-day01-08-eight-day-retrospective.md`
预期：`All matched files use Prettier code style!`

跑 `wc -l docs/review/2026-07-29-day01-08-eight-day-retrospective.md`
预期：约 80-100 行（§1 + §2 部分）。
...
cd d:/spaceObelish/spaceCode/playgroud/agent/agent-engineer-bootcamp
git add docs/review/2026-07-29-day01-08-eight-day-retrospective.md
git commit -m "docs(review): day01-08 retrospective section 2 - 8 day overview"
```

---

## Task 3: §3 Day 07 详细演进

**Files:**
- Modify: `docs/review/2026-07-29-day01-08-eight-day-retrospective.md`（追加 §3）

**Interfaces:**
- Consumes: day01-07 §1 Day 07 段（已读 source-of-truth，约 150 行）
- Consumes: day07.md 笔记
- Produces: §3 Day 07 详细（约 120 行）

**Content:**

- [ ] **Step 1: 写 §3 学习目标 + 代码产物**
...
cd d:/spaceObelish/spaceCode/playgroud/agent/agent-engineer-bootcamp
git add docs/review/2026-07-29-day01-08-eight-day-retrospective.md
git commit -m "docs(review): day01-08 retrospective section 3 - day 07 deep dive"
```

---

## Task 4: §4 Day 08 详细演进

**Files:**
- Modify: `docs/review/2026-07-29-day01-08-eight-day-retrospective.md`（追加 §4）

**Interfaces:**
- Consumes: day08.md 笔记（已读 source-of-truth，约 510 行）
- Consumes: [2026-07-28-day08-context-and-cost-observability-design.md](../../superpowers/specs/2026-07-28-day08-context-and-cost-observability-design.md)
- Produces: §4 Day 08 详细（约 200 行）

**Content:**

- [ ] **Step 1: 写 §4 学习目标 + 代码产物**
...
cd d:/spaceObelish/spaceCode/playgroud/agent/agent-engineer-bootcamp
git add docs/review/2026-07-29-day01-08-eight-day-retrospective.md
git commit -m "docs(review): day01-08 retrospective section 4 - day 08 deep dive"
```

---

## Task 5: §5 当前架构（Day 08 末态）

**Files:**
- Modify: `docs/review/2026-07-29-day01-08-eight-day-retrospective.md`（追加 §5）

**Interfaces:**
- Consumes: day01-07 §3 Day 7 架构图（已读）
- Consumes: day08.md §📚 知识点 5（Tailwind 三栏布局）
- Produces: §5 当前架构（约 80 行）

**Content:**

- [ ] **Step 1: 写 §5 架构图（Day 08 末态）**
...
cd d:/spaceObelish/spaceCode/playgroud/agent/agent-engineer-bootcamp
git add docs/review/2026-07-29-day01-08-eight-day-retrospective.md
git commit -m "docs(review): day01-08 retrospective section 5 - current architecture"
```

---

## Task 6: §6 核心概念复习（Day 07-08 增量）

**Files:**
- Modify: `docs/review/2026-07-29-day01-08-eight-day-retrospective.md`（追加 §6）

**Interfaces:**
- Consumes: day01-07 §3 核心概念（已读）
- Produces: §6 Day 07-08 增量概念（约 100 行，4 块）

**Content:**

- [ ] **Step 1: 写 §6 ChatUsage + best-effort + source/derived + snapshot 4 块**
...
cd d:/spaceObelish/spaceCode/playgroud/agent/agent-engineer-bootcamp
git add docs/review/2026-07-29-day01-08-eight-day-retrospective.md
git commit -m "docs(review): day01-08 retrospective section 6 - core concepts day07-08"
```

---

## Task 7: §7 ADR 增量（Day 07-08 新增 3 条）

**Files:**
- Modify: `docs/review/2026-07-29-day01-08-eight-day-retrospective.md`（追加 §7）

**Interfaces:**
- Consumes: day01-07 §4 ADR-001~012（已读，链接复用）
- Consumes: day07.md / day08.md 演进说明（commit 证据）
- Produces: §7 ADR 增量（约 80 行，3 条新 ADR）

**Content:**

- [ ] **Step 1: 写 §7 ADR-013 best-effort 派生**
...
cd d:/spaceObelish/spaceCode/playgroud/agent/agent-engineer-bootcamp
git add docs/review/2026-07-29-day01-08-eight-day-retrospective.md
git commit -m "docs(review): day01-08 retrospective section 7 - ADR increments"
```

---

## Task 8: §8 面试视角（STAR 法则） — 本次最大差异

**Files:**
- Modify: `docs/review/2026-07-29-day01-08-eight-day-retrospective.md`（追加 §8）

**Interfaces:**
- Consumes: day01-07 §7 面试视角（已读，链接复用追问部分）
- Consumes: §3 §4 §6 §7（已写）
- Produces: §8 STAR 法则 4 个亮点故事 + 5 分钟骨架 + 10 追问（约 250 行）

**Content:**

- [ ] **Step 1: 写 §8.1 项目概述（30 秒 STAR）**
...
- [ ] **Step 3: 写 §8.2 亮点 2（Source vs Derived 双写）**
...
- [ ] **Step 7: 写 §8.4 10 追问（含 Day 07-08 新增）**
...
cd d:/spaceObelish/spaceCode/playgroud/agent/agent-engineer-bootcamp
git add docs/review/2026-07-29-day01-08-eight-day-retrospective.md
git commit -m "docs(review): day01-08 retrospective section 8 - interview STAR stories"
```

---

## Task 9: §9 Day 09+ 路线 + 技术债 + 相关引用

**Files:**
- Modify: `docs/review/2026-07-29-day01-08-eight-day-retrospective.md`（追加 §9 + 相关引用）

**Interfaces:**
- Consumes: day01-07 §6 不足分析（已读，链接复用）
- Consumes: day08.md §"Day 09 预告"（已读）
- Produces: §9 Day 09+ 路线 + 技术债 + 相关引用（约 80 行）

**Content:**

- [ ] **Step 1: 写 §9 Day 09+ 路线 + 技术债**
...
| **web/ 单 HTML 530+ 行** | `apps/web/src/App.vue` + 旧 components | CSS 280+ 行，再加 200 行就要拆 | 引入 framework 时 |
...
| **scroll-to-iteration wired but non-functional**（Day 08 已修） | `apps/web/src/App.vue` | 功能链断最后一步（Day 08 抓出 fix） | ✅ Day 08 commit `555e722` |
| **trace-collector.test.ts 硬编码 kind 数组**（Day 08 已修） | `tests/apps/api/trace-collector.test.ts` | 加新 kind 时默默腐化 | ✅ Day 08 commit `0e72eeb` |
...
- **Day 08 spec**：[2026-07-28-day08-context-and-cost-observability-design.md](../superpowers/specs/2026-07-28-day08-context-and-cost-observability-design.md)
- **Day 08 plan**：[2026-07-28-day08-context-window-tailwind.md](../superpowers/plans/2026-07-28-day08-context-window-tailwind.md)
...
- **代码锚点**：
  ...
  - [apps/web/src/App.vue](../../apps/web/src/App.vue) — Vue 3 + Tailwind 4 三栏布局
...
- [ ] **Step 3: 验证总字数 + prettier + 跑全文检查**

跑 `wc -l docs/review/2026-07-29-day01-08-eight-day-retrospective.md`
预期：约 950-1100 行（§1-9 + 相关引用）。

跑 `pnpm exec prettier --check docs/review/2026-07-29-day01-08-eight-day-retrospective.md`
预期：`All matched files use Prettier code style!`

跑 `cat docs/review/2026-07-29-day01-08-eight-day-retrospective.md | grep -c '^#'`  → 数 section 数
预期：至少 9 个 `##` 开头（§1-9）+ 1 个 `#` 开头（title）。

跑 `cat docs/review/2026-07-29-day01-08-eight-day-retrospective.md | grep -c 'STAR'`
预期：至少 12 次（4 故事 × 3 处 S/T/A/R + 30 秒口述脚本）。

跑 `cat docs/review/2026-07-29-day01-08-eight-day-retrospective.md | grep -E 'ADR-0(13|14|15)' | wc -l`
预期：至少 3 次（每个 ADR 至少 1 次提及）。

跑 `git log --oneline docs/review/ | head -10`
预期：看到 9 个 commit（每个 task 一个）。

- [ ] **Step 4: 反例验证 4 条**

在回复中确认：

1. **"如果删掉 §8 STAR 故事，只剩 §1-7，技术亮点还成立吗？"** → 成立。STAR 是 narrative 包装，§3 §4 §6 §7 已含全部事实。
2. **"如果只看 §4 Day 08，能 get 到 Context 观测 + Tailwind 集成的核心吗？"** → 能。6 块演进说明 + 5 踩坑精简 + commit 链路。
3. **"如果只看 §8 STAR 故事，面试 5 分钟能 cover 8 天能力吗？"** → 能。4 故事（亮点 1-4）+ 5 分钟骨架 + 10 追问。
...
cd d:/spaceObelish/spaceCode/playgroud/agent/agent-engineer-bootcamp
git add docs/review/2026-07-29-day01-08-eight-day-retrospective.md
git commit -m "docs(review): day01-08 retrospective section 9 - day09+ roadmap + tech debt + refs"
```
...
- [x] **Spec 覆盖**：
  ...
  - §4 Day 08 详细 ✅ Task 4
  - §5 当前架构 ✅ Task 5
  - §6 核心概念（Day 07-08 增量）✅ Task 6
  - §7 ADR 增量 ✅ Task 7
  - §8 面试视角 STAR ✅ Task 8
  - §9 Day 09+ + 技术债 + 相关引用 ✅ Task 9

- [x] **占位符扫描**：0 个 TBD / TODO / "implement later"。所有内容均为实际 markdown。

- [x] **类型 / 命名一致性**：
  - `AgentEvent` 一致（12 kind）
  - `AgentTrace = { events, meta }` 一致
  - `countContextTokens` 一致
  - `MODELS` 注册表 一致
  - `run_summary` / `context` kind 名称一致
  - `Message` / `ChatRequest` / `ChatResponse` / `ChatOptions` / `ChatUsage` 一致

- [x] **commit 节奏**：9 个 commit，每个 task 一个（Task 1 → Task 9）。

- [x] **DRY / YAGNI**：
  - DRY：复用 day01-07 / day08.md 通过 markdown 链接，无重写
  - YAGNI：不预测 Day 09+ 未来，仅 day08.md 已 ack 的 5 决策

- [x] **不引入新代码**：纯文档 task，不动 libs/。

---

## Execution Handoff

**Plan complete and saved to `docs/superpowers/plans/2026-07-29-day01-08-retrospective.md`.**

9 个 task，单文档 review 写作。两种执行方式：

**1. Subagent-Driven (recommended)** — 每个 task 派一个独立 subagent 执行 + 完任务后 review；适合 9 步走 + 多次 commit。

**2. Inline Execution** — 当前 session 直接顺序执行 9 个 task，每个 task 走完后 commit。
